...
This is the preserved custom game. Open `rally-eleven.html`; references to `index.html` below describe its earlier entry point. The active root entry now opens the copied reference game.
